...
var LESSONS = [
  ...
  { id: 'getting-started/cloudstore-getting-started', section: 'getting-started', slug: 'getting-started/cloudstore-getting-started', titleEN: 'Getting Started with CloudStore', titleFR: 'Premiers pas avec CloudStore', difficulty: 'beginner', estimatedMinutes: 20 },
  { id: 'getting-started/landing-zone-manager', section: 'getting-started', slug: 'getting-started/landing-zone-manager', titleEN: 'Landing Zone Manager', titleFR: 'Landing Zone Manager', difficulty: 'beginner', estimatedMinutes: 15 },
